...
* The [live server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer) extension for visual studio code
...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/edcsu/udacity-starter-website
   ```

2. Click live server at the bottom panel of Visual studio code.
...
[linkedin-url]: https://linkedin.com/in/ssewannonda-keith-edwin-443303129
